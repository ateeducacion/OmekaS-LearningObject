...
Read [learning-object-packages](.agents/skills/learning-object-packages/SKILL.md) when you need to: change SCORM/eXe package ingestion, extraction, thumbnails, rendering, or deletion cleanup.
